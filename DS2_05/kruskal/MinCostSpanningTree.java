...
public class MinCostSpanningTree {
	...
	private void setsSpanningTreeEdgeList(List<WeightedEdge> newSpanningTreeEdgeList) {
	...
	public MinCostSpanningTree() {
		...
		this.setsSpanningTreeEdgeList(null);
	}
	...
	public List<WeightedEdge> solve(WeightedUndirectedAdjacencyMatrixGraph<WeightedEdge> aGraph) {
		...
		this.setsSpanningTreeEdgeList(new LinkedList<WeightedEdge>());
