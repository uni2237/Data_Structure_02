...
public class AppController {
	...
	private void outputValidationMessage(Sort<Integer> aSort, Integer[] aList) {
		AppView.output("-[" + this.listTypeNmae() + "]에 대한 [" + this.sortingOrderName(aSort) + "]의 ["
				+ aSort.getClass().getSimpleName() + "] 결과는 ");
		if (this.sortedListIsVaild(aList, aSort.nonDecreasingOrder())) {
	...
	private boolean sortedListIsVaild(Integer[] aList, boolean nonDecreasing) {
		if (nonDecreasing) {
